...
export default function SalesManagerPage() {
  ...
  const currentRoute = '/(tabs)/sales-manager';
  ...
  const responsibilities = [
    ...
    'Develop sales strategies and territories',
    'Train and onboard new sales representatives',
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.titleContainer}>
          <Text style={[styles.title, { color: colors.text }]}>Sales Manager</Text>
        </View>
        ...
        <View style={styles.infoCardsContainer}>
          <View style={[styles.infoCard, { backgroundColor: colors.cardBackground, borderColor: colors.border }]}>
            ...
            <Text style={[styles.infoValue, { color: colors.text }]}>$65K - $125K</Text>
          </View>
          ...
          <View style={[styles.infoCard, { backgroundColor: colors.cardBackground, borderColor: colors.border }]}>
            ...
            <Text style={[styles.infoSubValue, { color: colors.textSecondary }]}>(13% annually)</Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={[styles.aboutText, { color: colors.textSecondary }]}>
            Sales Managers lead sales teams to meet revenue targets. They develop sales strategies, coach team members, and build relationships with important clients to drive business growth and profitability.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.educationContainer}>
            ...
            <Text style={[styles.educationText, { color: colors.textSecondary }]}>
              Bachelor's degree in Business, Marketing, or related field with proven sales experience
            </Text>
          </View>
        </View>
      ...
      {/* Bottom Buttons */}
      <JobFooter currentRoute={currentRoute} careerName="sales-manager" />
    </View>
  );
}
