...
export default function EnvironmentalScientistPage() {
  ...
  const currentRoute = '/(tabs)/environmental-scientist';
  ...
  const responsibilities = [
    'Monitor environmental conditions and pollution',
    'Analyze environmental data and samples',
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.titleContainer}>
          <Text style={[styles.title, { color: colors.text }]}>Environmental Scientist</Text>
        </View>
        ...
        <View style={styles.infoCardsContainer}>
          <View style={[styles.infoCard, { backgroundColor: colors.cardBackground, borderColor: colors.border }]}>
            ...
            <Text style={[styles.infoValue, { color: colors.text }]}>$60K - $100K</Text>
          </View>
          ...
          <View style={[styles.infoCard, { backgroundColor: colors.cardBackground, borderColor: colors.border }]}>
            ...
            <Text style={[styles.infoSubValue, { color: colors.textSecondary }]}>(10% annually)</Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={[styles.aboutText, { color: colors.textSecondary }]}>
            Environmental Scientists protect the environment and human health by studying pollution, climate change, and natural resources. They conduct field research, analyze data, and develop strategies to solve environmental problems.
          </Text>
        </View>
