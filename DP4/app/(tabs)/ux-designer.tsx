...
export default function UXDesignerPage() {
  ...
  const currentRoute = '/(tabs)/ux-designer';
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.titleContainer}>
          <Text style={[styles.title, { color: colors.text }]}>UX Designer</Text>
        </View>
        ...
        <View style={styles.infoCardsContainer}>
          ...
          <View style={[styles.infoCard, { backgroundColor: colors.cardBackground, borderColor: colors.border }]}>
            ...
            <Text style={[styles.infoSubValue, { color: colors.textSecondary }]}>(15% annually)</Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={[styles.aboutText, { color: colors.textSecondary }]}>
            UX Designers create meaningful and delightful experiences for users. They research user needs, design intuitive interfaces, and ensure products are both functional and enjoyable to use.
          </Text>
        </View>
      ...
      {/* Bottom Buttons */}
      <JobFooter currentRoute={currentRoute} careerName="ux-designer" />
    </View>
  );
}
