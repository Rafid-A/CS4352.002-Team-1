...
export default function MarketingManagerPage() {
  ...
  const currentRoute = '/(tabs)/marketing-manager';
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.titleContainer}>
          <Text style={[styles.title, { color: colors.text }]}>Marketing Manager</Text>
        </View>
        ...
        <View style={styles.infoCardsContainer}>
          <View style={[styles.infoCard, { backgroundColor: colors.cardBackground, borderColor: colors.border }]}>
            ...
            <Text style={[styles.infoValue, { color: colors.text }]}>$60K - $115K</Text>
          </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={[styles.aboutText, { color: colors.textSecondary }]}>
            Marketing Managers develop and execute marketing strategies to promote products and services. They lead teams, analyze market trends, and drive brand awareness to achieve business goals.
          </Text>
        </View>
      ...
      {/* Bottom Buttons */}
      <JobFooter currentRoute={currentRoute} careerName="marketing-manager" />
    </View>
  );
}
