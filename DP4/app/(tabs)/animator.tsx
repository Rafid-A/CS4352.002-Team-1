...
export default function AnimatorPage() {
  ...
  const currentRoute = '/(tabs)/animator';
  ...
  const responsibilities = [
    'Create animated sequences and characters',
    'Develop storyboards and animation concepts',
    'Use software to produce 2D and 3D animations',
    'Collaborate with directors and creative teams',
    'Edit and refine animations based on feedback'
  ];
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.titleContainer}>
          <Text style={[styles.title, { color: colors.text }]}>Animator</Text>
        </View>
        ...
        <View style={styles.infoCardsContainer}>
          <View style={[styles.infoCard, { backgroundColor: colors.cardBackground, borderColor: colors.border }]}>
            ...
            <Text style={[styles.infoValue, { color: colors.text }]}>$55K - $95K</Text>
          </View>
          ...
          <View style={[styles.infoCard, { backgroundColor: colors.cardBackground, borderColor: colors.border }]}>
            ...
            <Text style={[styles.infoSubValue, { color: colors.textSecondary }]}>(12% annually)</Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={[styles.aboutText, { color: colors.textSecondary }]}>
            Animators bring characters and stories to life through motion. They work in film, television, video games, and advertising, creating 2D and 3D animations that entertain and inform audiences.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.educationContainer}>
            ...
            <Text style={[styles.educationText, { color: colors.textSecondary }]}>
              Bachelor's degree in Animation, Computer Graphics, or related field (or strong portfolio)
            </Text>
          </View>
        </View>
      ...
      {/* Bottom Buttons */}
      <JobFooter currentRoute={currentRoute} careerName="animator" />
    </View>
  );
}
