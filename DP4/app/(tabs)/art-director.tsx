...
export default function ArtDirectorPage() {
  ...
  const currentRoute = '/(tabs)/art-director';
    ...
    <View style={globalStyles.container}>
      <ScrollView style={globalStyles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.titleContainer}>
          <Text style={[styles.title, { color: colors.text }]}>Art Director</Text>
        </View>
        ...
        <View style={styles.infoCardsContainer}>
          <View style={[styles.infoCard, { backgroundColor: colors.cardBackground, borderColor: colors.border }]}>
            ...
            <Text style={[styles.infoValue, { color: colors.text }]}>$70K - $130K</Text>
          </View>
          ...
          <View style={[styles.infoCard, { backgroundColor: colors.cardBackground, borderColor: colors.border }]}>
            ...
            <Text style={[styles.infoSubValue, { color: colors.textSecondary }]}>(11% annually)</Text>
          </View>
        </View>
      ...
      {/* Bottom Buttons */}
      <JobFooter currentRoute={currentRoute} careerName="art-director" />
    </View>
  );
}
