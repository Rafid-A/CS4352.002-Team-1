...
export default function DevOpsEngineerPage() {
  ...
  const currentRoute = '/(tabs)/devops-engineer';
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.titleContainer}>
          <Text style={[styles.title, { color: colors.text }]}>DevOps Engineer</Text>
        </View>
        ...
        <View style={styles.infoCardsContainer}>
          <View style={[styles.infoCard, { backgroundColor: colors.cardBackground, borderColor: colors.border }]}>
            ...
            <Text style={[styles.infoValue, { color: colors.text }]}>$85K - $145K</Text>
          </View>
          ...
          <View style={[styles.infoCard, { backgroundColor: colors.cardBackground, borderColor: colors.border }]}>
            ...
            <Text style={[styles.infoSubValue, { color: colors.textSecondary }]}>(21% annually)</Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={[styles.aboutText, { color: colors.textSecondary }]}>
            DevOps Engineers bridge the gap between development and operations teams. They automate processes, manage infrastructure, and ensure smooth deployment and monitoring of applications in production environments.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.educationContainer}>
            ...
            <Text style={[styles.educationText, { color: colors.textSecondary }]}>
              Bachelor's degree in Computer Science, Information Technology, or related field (certifications highly valued)
            </Text>
          </View>
        </View>
      ...
      {/* Bottom Buttons */}
      <JobFooter currentRoute={currentRoute} careerName="devops-engineer" />
    </View>
  );
}
