...
export default function SciencesPage() {
  ...
  const currentRoute = '/(tabs)/sciences';
    ...
    <View style={globalStyles.container}>
      <ScrollView style={globalStyles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.titleContainer}>
          <Text style={[styles.title, { color: colors.text }]}>Sciences</Text>
            ...
            <TouchableOpacity 
              ...
              onPress={() => {
                if (career.title === 'Data Scientist') {
                  ...
                  router.push({ pathname: '/(tabs)/research-scientist', params: { from: currentRoute } } as any);
                } else if (career.title === 'Biotech Engineer') {
                  router.push({ pathname: '/(tabs)/biotech-engineer', params: { from: currentRoute } } as any);
                } else if (career.title === 'Environmental Scientist') {
                  router.push({ pathname: '/(tabs)/environmental-scientist', params: { from: currentRoute } } as any);
                }
              }}
            >
        ...
        <View style={[styles.guidanceContainer, { backgroundColor: colors.primaryLight }]}>
          ...
          <View style={styles.buttonColumn}>
            ...
            <TouchableOpacity 
              ...
              activeOpacity={0.8}
              onPress={() => router.push('/courses?category=sciences' as any)}
            >
