...
export default function GraphicDesignerPage() {
  ...
  const currentRoute = '/(tabs)/graphic-designer';
  ...
  const responsibilities = [
    'Create visual concepts and brand assets',
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.titleContainer}>
          <Text style={[styles.title, { color: colors.text }]}>Graphic Designer</Text>
        </View>
        ...
        <View style={styles.infoCardsContainer}>
          <View style={[styles.infoCard, { backgroundColor: colors.cardBackground, borderColor: colors.border }]}>
            ...
            <Text style={[styles.infoValue, { color: colors.text }]}>$40K - $75K</Text>
          </View>
          ...
          <View style={[styles.infoCard, { backgroundColor: colors.cardBackground, borderColor: colors.border }]}>
            ...
            <Text style={[styles.infoSubValue, { color: colors.textSecondary }]}>(8% annually)</Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={[styles.aboutText, { color: colors.textSecondary }]}>
            Graphic Designers create visual content to communicate messages. They combine art and technology to develop designs for advertising, branding, publications, and digital media.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.educationContainer}>
            ...
            <Text style={[styles.educationText, { color: colors.textSecondary }]}>
              Bachelor's degree in Graphic Design, Visual Arts, or related field (or portfolio demonstrating skills)
            </Text>
          </View>
        </View>
      ...
      {/* Bottom Buttons */}
      <JobFooter currentRoute={currentRoute} careerName="graphic-designer" />
    </View>
  );
}
